resource search get_configs {
  ...
  <searchSection>
    ...
    <valueFields OutputType="SQLXML">
      ...
      <valueField id="LogoSD" fieldName="asset.urlAbsolut(${to_string(data.destination.frontenddata_sm.item_guid)},${to_string(data.media_format.source_copy.item_guid)})">
      ...
      <valueField id="SplashscreenVideoH264Tablet" fieldName="asset.urlAbsolut(${to_string(data.destination.frontenddata_sm.item_guid)},${to_string(data.media_format.tablet_h264_2048kbit_ffmpeg_50017.item_guid)})">
