resource search digizuite_system_framework_my_videos {
    version_id = resource.product.digizuite_mobile.base_version_id
    name = 'DigiZuite_System_Framework_My_Videos'
    is_customizable = false
    search_xml = '<search name="DigiZuite_System_Framework_My_Videos">
  <searchSection>
    <searchFields>
      ...
      <searchFields id="asset" operator="AND">
