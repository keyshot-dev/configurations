resource search getallbackendgroups {
    version_id = resource.product.digizuite_mobile.base_version_id
    name = 'GetAllBackendGroups'
    is_customizable = false
    search_xml = '<search name="GetAllBackendGroups">
  <searchSection>
    <searchFields>
      ...
      <searchField id="isUserGroup" fieldName="member_group.is_me_group" operator="AND" valueHandler="Equals">
