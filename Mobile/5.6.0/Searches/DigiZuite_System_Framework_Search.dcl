resource search digizuite_system_framework_search {
  ...
  <searchSection>
    <searchFields>
      ...
      <searchField id="sIsPublic" itemGuid="${to_string(resource.bit_metafield.is_public_50573.item_guid)}" operator="AND" valueHandler="Equals" visible="false" />
    ...
    <valueFields OutputType="SQLXML">
      ...
      <valueField id="orientedWidth" fieldName="asset.orientedWidth" />
      <valueField id="imageHeight" fieldName="asset.image_height" />
      <valueField id="orientedHeight" fieldName="asset.orientedHeight" />
      ...
      <valueField id="ispublic" itemGuid="${to_string(data.bit_metafield.is_public.item_guid)}" returnType="bool" />
      ...
      <valueField id="pdfUrl" fieldName="asset.urlAbsolut(${to_string(data.destination.frontenddata_sm.item_guid)},${to_string(data.media_format.source_copy.item_guid)})" />
    </valueFields>
    <sortFields>
