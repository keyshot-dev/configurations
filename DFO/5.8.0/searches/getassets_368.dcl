resource search getassets_368 {
  ...
  <searchSection>
    ...
    <valueFields OutputType="SQLXML">
      ...
      <valueField fieldName="asset.urlAbsolut(${to_string(data.storage_manager_destination.asset_storage_sm.item_guid)},${to_string(data.media_format.thumb_1920x1080_2.item_guid)})" id="videoPoster" />
