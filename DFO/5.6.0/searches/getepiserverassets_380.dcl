resource search getepiserverassets_380 {
  ...
  <searchSection>
    ...
    <valueFields OutputType="SQLXML">
      ...
      <valueField fieldName="asset.urlAbsolut(${to_string(data.destination.frontenddata_sm.item_guid)},${to_string(resource.media_format.jpg_big_50034.item_guid)})" id="ImageBig" />
