...
resource configservice_label settings_about_dc_product_version {
  key = 'SETTINGS_ABOUT_DC_PRODUCT_VERSION'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
...
resource configservice_label settings_about_mm_product_version {
  key = 'SETTINGS_ABOUT_MM_PRODUCT_VERSION'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
...
resource configservice_label settings_about_release_version_id {
  key = 'SETTINGS_ABOUT_RELEASE_VERSION_ID'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'Release version:'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Releaseversion:'
      language_id = data.language.danish.id
    }
  ]
}
...
resource configservice_label asset_card_settings_description {
  ...
  default_label_values = [
    {
      default_translation = 'Customize buttons, more menu items, and metadata fields. Set the configuration for both Media Manager and connectors.'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Tilpas knapper, mere-menu-elementer og metadatafelter. Sæt konfiguration for både Media Manager og connectors.'
      language_id = data.language.danish.id
    }
  ]
}

resource configservice_label asset_card_settings_visible_actions_section_header {
  key = 'ASSET_CARD_SETTINGS_VISIBLE_ACTIONS_SECTION_HEADER'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'Visible buttons'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Synlige knapper'
      language_id = data.language.danish.id
    }
  ]
}
...
resource configservice_label asset_card_settings_visible_actions_section_description {
  key = 'ASSET_CARD_SETTINGS_VISIBLE_ACTIONS_SECTION_DESCRIPTION'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'Choose up to four buttons to display. You can also change the order of the buttons.'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Vælg op til fire knapper, der skal vises. Du kan også ændre rækkefølgen af knapperne.'
      language_id = data.language.danish.id
    }
  ]
}

resource configservice_label asset_card_settings_visible_actions_disabled_tooltip {
  key = 'ASSET_CARD_SETTINGS_VISIBLE_ACTIONS_DISABLED_TOOLTIP'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'The upper limit is four buttons'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Fire knapper er den øvre grænse'
      language_id = data.language.danish.id
    }
  ]
}

resource configservice_label asset_card_settings_media_manager_tab_label {
  key = 'ASSET_CARD_SETTINGS_MEDIA_MANAGER_TAB_LABEL'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
...
resource configservice_label asset_card_settings_connector_tab_label {
  key = 'ASSET_CARD_SETTINGS_CONNECTOR_TAB_LABEL'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'Connector'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Connector'
...
resource configservice_label asset_card_settings_more_actions_section_header {
  key = 'ASSET_CARD_SETTINGS_MORE_ACTIONS_SECTION_HEADER'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'More menu items'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Mere-menu-elementer'
      language_id = data.language.danish.id
    }
  ]
}

resource configservice_label asset_card_settings_more_actions_section_description {
  key = 'ASSET_CARD_SETTINGS_MORE_ACTIONS_SECTION_DESCRIPTION'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'Choose items to display in the more menu. You can also change the order of the items.'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Vælg elementer, der skal vises i mere-menuen. Du kan også ændre rækkefølgen af items.'
      language_id = data.language.danish.id
    }
  ]
}

resource configservice_label asset_card_settings_title_description_section_header {
  key = 'ASSET_CARD_SETTINGS_TITLE_DESCRIPTION_SECTION_HEADER'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
...
resource configservice_label asset_card_settings_title_description_section_description {
  key = 'ASSET_CARD_SETTINGS_TITLE_DESCRIPTION_SECTION_DESCRIPTION'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'Customize the metadata field that is shown below the title'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Tilpas metadatafeltet, der vises under titlen'
      language_id = data.language.danish.id
    }
  ]
}

resource configservice_label asset_card_settings_title_description_section_no_selected_value {
  key = 'ASSET_CARD_SETTINGS_TITLE_DESCRIPTION_SECTION_NO_SELECTED_VALUE'
  group = 'Settings'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'No value selected. Description field is shown.'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Ingen værdi valgt. Beskrivelse er vist.'
      language_id = data.language.danish.id
    }
  ]
}
