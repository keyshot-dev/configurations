...
resource configservice_label creative_cloud_connector_link_more_popup_reveal_in_explorer {
  key = 'CREATIVE_CLOUD_CONNECTOR_LINK_MORE_POPUP_REVEAL_IN_EXPLORER'
  group = 'Creative Cloud Connector'
  product_id = resource.configservice_product.media_manager_5.id
  default_label_values = [
    {
      default_translation = 'Reveal in Explorer'
      language_id = data.language.english.id
    },
    {
      default_translation = 'Se i Explorer'
      language_id = data.language.danish.id
    }
  ]
}
