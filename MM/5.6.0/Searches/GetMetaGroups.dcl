resource search get_meta_groups {
    version_id = resource.product.media_manager.base_version_id
    name = 'GetMetaGroups'
    is_customizable = false
    search_xml = '<search xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" name="GetMetaGroups" xsi:schemaLocation="http://www.w3schools.com http://documentation.digizuite.dk/schemas/digizuite/search2.xsd">
  <searchSection>
    <searchFields>
