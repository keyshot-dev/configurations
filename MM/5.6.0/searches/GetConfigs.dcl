  ...
  <searchSection>
    ...
    <valueFields OutputType="SQLXML">
      ...
      <valueFields id="SecondaryLogo">
        ...
        <valueField id="SecondaryLogoURL" fieldName="asset.urlAbsolut(${to_string(data.destination.frontenddata_sm.item_guid)},${to_string(data.media_format.source_copy.item_guid)})" />
      ...
      <valueField id="SplashscreenImage" fieldName="asset.urlAbsolut(${to_string(data.destination.asset_storage_sm.item_guid)},${to_string(data.media_format.thumb_1920x1080.item_guid)})">
      ...
      <valueField id="SplashscreenVideoH264Desktop" fieldName="asset.urlAbsolut(${to_string(data.destination.frontenddata_sm.item_guid)},${to_string(data.media_format.desktop_h264_2048kbit_ffmpeg.item_guid)})">
      ...
      <valueField id="SplashscreenVideoH264Tablet" fieldName="asset.urlAbsolut(${to_string(data.destination.frontenddata_sm.item_guid)},${to_string(data.media_format.tablet_h264_2048kbit_ffmpeg.item_guid)})">
      ...
      <valueField id="SplashscreenVideoH264Mobile" fieldName="asset.urlAbsolut(${to_string(data.destination.frontenddata_sm.item_guid)},${to_string(data.media_format.mobile_h264_1024kbit_ffmpeg.item_guid)})">
