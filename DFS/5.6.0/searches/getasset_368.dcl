      ...
      <valueFields id="metaData" isArray="true">
        ...
        <valueField id="metaFieldId" fieldStructure="item_metafield.item_metafieldid">
          <bindField id="valueMetafieldBind">
            <new id="valueMetafieldBindCurrent" fieldStructure="item_metafield.item_metafieldid" />
            <current id="valueMetafieldBindNew" fieldStructure="item_metafield_label.item_metafieldid">
              <bindField id="metafieldLabelBind">
                <new id="metafieldLabelBindNew1" fieldStructure="item_metafield_label.item_metafield_labelid" />
                <current id="metafieldLabelBindCurrent1" fieldName="item_metafield_value.item_metafield_labelid" />
              </bindField>
            </current>
          </bindField>
        </valueField>
        <valueField id="datatype" fieldStructure="item_metafield.item_datatypeid" bindId="metaFieldId" />
      </valueFields>
