resource search get_assets {
  ...
  <searchSection>
    ...
    <valueFields OutputType="SQLXML">
      ...
      <valueField fieldName="asset.urlAbsolut(${to_string(resource.storage_manager_destination.asset_storage_sm.item_guid)},${to_string(resource.media_format.thumb_200x120_3.item_guid)})" id="thumb" />
      <valueField fieldName="asset.downloadUrlAbsolut(${to_string(resource.storage_manager_destination.asset_storage_sm.item_guid)})" id="downloadSource" />
      <valueField fieldName="asset.urlAbsolut(${to_string(resource.storage_manager_destination.asset_storage_sm.item_guid)},${to_string(resource.media_format.thumb_1920x1080_2.item_guid)})" id="imagePreview" />
      <valueField fieldName="asset.urlAbsolut(${to_string(resource.storage_manager_destination.asset_storage_sm.item_guid)},${to_string(resource.media_format.video_preview_h264_10079.item_guid)})" id="videoPreview" />
      <valueField fieldName="asset.urlAbsolut(${to_string(resource.storage_manager_destination.asset_storage_sm.item_guid)},${to_string(resource.media_format.thumb_1920x1080_2.item_guid)})" id="videoPoster" />
