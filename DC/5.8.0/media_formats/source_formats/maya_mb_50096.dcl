resource media_format maya_mb_50096 {
    folder_id = resource.media_format_folder.source_formats.id
    format_type_id = resource.media_format_type.maya_mb_190014.media_format_type_id
    name = 'Maya (mb)'
    description = ''
    width = 0
    height = 0
    ...
    autolink = {
        item_guid = '9c14c9b3-66c2-4a3d-978b-840c5e919b88'
    }
}
