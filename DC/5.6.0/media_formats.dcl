...
resource media_transcode extract_exifthumb_from_indesign_50015 {
    ...
    folder_id = resource.transcode_folder.import_10000.id
    embed_metadefinition = ''
    source_media_format_id = resource.media_format.adobe_indesign.media_format_id
...
resource media_transcode pdf__thumb_200x120_12 {
    ...
    folder_id = resource.transcode_folder.standard_10001.id
    embed_metadefinition = ''
    source_media_format_id = resource.media_format.adobe_pdf.media_format_id
    target_media_format_id = resource.media_format.thumb_200x120_3.media_format_id
    prevref = 0
}
...
resource media_format adobe_pdf {
    folder_id = resource.media_format_folder.import_10000.id
    format_type_id = resource.media_format_type.portable_document_format_40002.media_format_type_id
    name = 'Adobe PDF'
    description = ''
...
resource media_transcode adobe_pdf_page_image_aspose_50267 {
    ...
    embed_metadefinition = ''
    source_media_format_id = resource.media_format.adobe_pdf.media_format_id
    target_media_format_id = resource.media_format.adobe_pdf_page_image.media_format_id
    prevref = 0
}
...
resource media_format_type portable_document_format_40002 {
    ...
    identity_media_format_id = resource.media_format.adobe_pdf.media_format_id
}

resource media_format adobe_illustrator {
    folder_id = resource.media_format_folder.import_10000.id
    format_type_id = resource.media_format_type.adobe_illustrator.media_format_type_id
...
resource media_format_type indesign_100001 {
    ...
    identity_media_format_id = resource.media_format.adobe_indesign.media_format_id
}
...
resource media_format adobe_pdf_page_image {
    folder_id = resource.media_format_folder.import_10000.id
...
resource media_transcode adobe_pdf__adobe_pdf_preview {
...
resource media_format_type adobe_illustrator {
...
resource media_transcode extract_exifthumb_from_illustrator_50017 {
    ...
    folder_id = resource.transcode_folder.import_10000.id
    embed_metadefinition = ''
    source_media_format_id = resource.media_format.adobe_illustrator.media_format_id
    target_media_format_id = resource.media_format.exifthumb_raw_50014.media_format_id
    prevref = 0
}
...
resource media_format adobe_indesign {
    folder_id = resource.media_format_folder.import_10000.id
