resource media_format keyshot_environment_50091 {
    folder_id = resource.media_format_folder.source_formats.id
    format_type_id = resource.media_format_type.keyshotenvironment_1060002.media_format_type_id
    ...
    autolink = {
        item_guid = 'ecb0efce-35ad-4167-836a-7eb16736a72b'
    }
}
