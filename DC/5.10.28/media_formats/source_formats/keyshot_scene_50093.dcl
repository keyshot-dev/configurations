resource media_format keyshot_scene_50093 {
    folder_id = resource.media_format_folder.source_formats.id
    format_type_id = resource.media_format_type.keyshotscene_1060004.media_format_type_id
    name = 'KeyShot Scene'
    description = ''
    width = 0
    height = 0
    ...
    autolink = {
        item_guid = '65ed037e-5f5b-4efa-8d55-f29749243426'
    }
}
